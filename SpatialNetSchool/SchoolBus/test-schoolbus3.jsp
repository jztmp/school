...
<script src="js/test-schoolbus3.js"></script>
...
to {
			...
			<div class="details-content">
				<div class="user-head">
					...
					<div class="user-infor">
						<div id="nameDiv" class="name">testbus3</div>
						<div id="telDiv" class="tel">testbus3</div>
    <a href="#" onclick=""><div id="timeDiv" class="time"></div></a>
				...
				<div class="user-heart">
					...
					<div class="heart-number" id="heartNumber">04-19</div>
				</div>
