...
to {
			...
			<div class="details-content">
				<div class="user-head">
					...
					<div class="user-infor">
						<div id="nameDiv" class="name">Smith's Bus</div>
						<div id="telDiv" class="tel">12564281800</div>
    <a href="#" onclick=""><div id="timeDiv" class="time"></div></a>
				...
				<div class="user-heart">
					<div class="dividing-line"><a href="#" onclick="api.showMapodb2()"><div id="htime" class="htime"></div></a></div>
