...
<script src="js/watch1997.js"></script>
				...
				class="ui-corner-all">
					<div style="padding:10px 20px;">
						<label for="un" class="ui-hidden-accessible">Please enter the information</label> <input
							...
							data-theme="a">
						<button class="ui-btn ui-corner-all ui-shadow ui-btn-b ui-btn-icon-left ui-icon-check" onclick="api.sendMessage()">submit</button>
					</div>
			</div>
			<h1>Heartbeat</h1>
			<a href="#"
				class="ui-btn-right ui-btn ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right ui-icon-recycle"
				onclick="api.getHeartbeat()">Refresh</a>
		</div>
			...
			<div class="details-content">
				<div class="user-head">
					...
					<div class="user-infor">
						<div id="nameDiv" class="name">Dr.Wu</div>
						<div id="telDiv" class="tel">12566516248</div>
    <a href="#" onclick="api.showMap()"><div id="timeDiv" class="time"></div></a>
					</div>
				</div>


				<div class="user-heart">
					<div class="dividing-line"><div id="htime" class="htime"></div></div>
