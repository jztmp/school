...
<script src="js/schoolbus.js"></script>
    ...
    case error.UNKNOWN_ERROR:
      ...
      break;
			...
			function showPosition(position){
				$("#htime").html(position.coords.latitude + ',' + position.coords.longitude);
			}
			function getLocation(){
			    if (navigator.geolocation){
					navigator.geolocation.watchPosition(showPosition,showError);
				} else {
					alert('the feature of geolocation is not supported.');
				}
			}
...
to {
	-webkit-transform: rotate(360deg) translateZ(0);
		...
		<div data-role="header">
			...
			<a href="#"
				...
				onclick="api.getODB2GPS()">Refresh</a>
		</div>

		<div data-role="content">
			<div class="details-content">
				<div class="user-head">
					<img src="img/logo.png" alt="John"
						class="image-wrap">
					<div class="user-infor">
						<div id="nameDiv" class="name">No data</div>
						<div id="telDiv" class="tel">No data</div>
    <a href="#" onclick=""><div id="timeDiv" class="time"></div></a>
				...
				<div class="user-heart">
					<div class="dividing-line"><a href="#" onclick="api.showMapodb2()"><div id="htime" class="htime">Tracking......</div></a></div>
					<div class="heart-number" id="heartNumber">No data</div>
				</div>
